...
<!-- Sidebar section -->
<!-- <div class="sidenav">
  <div class="logo" style="padding: 10px 10px 6px 3px;">
   <a href="<?=base_url()?>"><h2>SAHAM</h2></a>
 </div>
...
<?php $this->load->view('Saham/menu.php');?>
  ...
  <div class="col-lg-12">
    <div class="row" style="height: 60px; padding-bottom: 5px; margin-top: 4px;">
      <div class="col" style=" padding-left: 12px;">
        <a href="<?=base_url()?>index.php/dashboard/FormInput">
          <button  type="button" id="btnAddEmiten" class="btn btn-info btn-sm"><i class="fas fa-plus"></i> Input Data</button></a>
        </div>
        <br>
      </div>
