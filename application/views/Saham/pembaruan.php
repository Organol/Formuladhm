...
<div class="main">
	<div class="col-lg-12">
		<main class="sticky-footer-container-item --pushed" position="fixed" style="height: 60px; padding-bottom: 5px; margin-top: 4px;">
			<div class="col" style=" padding-left: 12px;">
				<div class="block-double">
	        		<a href="#">
	          			<button  type="button" id="btnAddEmiten" class="btn btn-primary" position="fixed" >Add Data Emiten</button>
	          		</a>
          		</div>
        	</div>
